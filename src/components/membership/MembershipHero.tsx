        ...
        <section className="relative flex min-h-[90vh] w-full flex-col items-center justify-center overflow-hidden px-6 pt-32 pb-20 md:px-16 lg:px-24">
            ...
            <div className="z-10 flex flex-col items-center text-center w-full max-w-5xl mx-auto">
                <motion.div
                    ...
                    className="mb-10 inline-flex items-center rounded-full border border-[rgba(212,175,55,0.2)] bg-[rgba(212,175,55,0.05)] px-4 py-1.5 backdrop-blur-md"
                >
                    <span className="text-[10px] uppercase tracking-widest text-[#d4af37] font-medium">Membership</span>
                </motion.div>
