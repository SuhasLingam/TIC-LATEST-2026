...
export function FAQ() {
    ...
    return (
        ...
        >
            {/* Top separator */}
            <div className="w-full max-w-7xl mx-auto border-t border-foreground/10 mb-20" />

            <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-20 items-start">
                ...
                >
                    <p className="font-sans text-xs tracking-[0.2em] uppercase text-foreground/40 mb-3">
                        Got questions
                    </p>
                    <h2 className="font-heading text-3xl md:text-4xl font-medium tracking-tight text-foreground leading-tight">
                        Frequently<br />asked
                    </h2>
                </motion.div>
                    ...
                    {faqs.map((faq, i) => (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span className={`font-sans text-sm transition-colors ${openIndex === i ? "text-foreground" : "text-foreground/70"
                                        }`}>
                                        {faq.q}
                                    </span>
                                    <span className={`shrink-0 transition-all duration-300 ${openIndex === i ? "text-foreground" : "text-foreground/35"
                                        }`}>
                                        {openIndex === i
                                ...
                                <AnimatePresence initial={false}>
                                    {openIndex === i && (
                                        ...
                                        >
                                            <p className="font-sans text-sm text-foreground/55 leading-relaxed px-5 pb-5">
                                                {faq.a}
                                            </p>
                                        </motion.div>
                                    )}
