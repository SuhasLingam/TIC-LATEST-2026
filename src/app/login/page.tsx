  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-6 py-24">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="bg-foreground/[0.03] h-[400px] w-[500px] rounded-full blur-[120px]" />
      </div>
      ...
      >
        {/* Eyebrow */}
        <p className="text-foreground/35 mb-8 font-sans text-[9px] tracking-widest uppercase">
          Member Access
        </p>

        {error && (
          <div className="mb-6 border border-red-500/20 bg-red-500/5 px-4 py-3 font-sans text-xs text-red-500 dark:text-red-400">
            {error}
          </div>
        )}
        ...
        {step === "email" && (
          ...
          >
            <h1 className="font-heading text-foreground mb-2 text-4xl tracking-tight md:text-5xl">
              Welcome back.
            </h1>
            <p className="text-foreground/50 mb-10 font-sans text-sm">
          ...
          >
            ...
            <div className="mb-5">
              <input
                ...
                className="bg-foreground/[0.03] border-foreground/10 font-heading text-foreground placeholder:text-foreground/20 focus:border-foreground/30 w-full rounded-none border px-4 py-5 text-center text-2xl tracking-[0.5em] transition-colors focus:outline-none"
                autoFocus
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="text-foreground/30 hover:text-foreground w-full py-2 font-sans text-[9px] tracking-[0.3em] uppercase transition-colors"
              >
                Back
              </button>
            </div>
        ...
        <div className="border-foreground/10 mt-12 border-t pt-8">
          <p className="text-foreground/30 text-center font-sans text-xs">
            Not a member yet?{" "}
            <a
              href="/membership"
